...
SAMPLE_CONTACTS = [
    ContactCreate(
        ...
        addresses=[AddressCreate(type="Home", city="San Francisco", state="CA", country="USA")],
    ),
    ContactCreate(
        first_name="Grace",
        last_name="Hopper",
        ...
        addresses=[AddressCreate(type="Work", city="Arlington", state="VA", country="USA")],
    ),
    ContactCreate(
        first_name="Alan",
        last_name="Turing",
        ...
        addresses=[AddressCreate(type="Work", city="London", country="UK")],
    ),
]
